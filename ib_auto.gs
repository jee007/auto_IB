...
function renameDownloadedFilesFinal2() {
  ...
  countDownBeforeExecution(1, 10, uploadSpecificFilesToGoogleSheet);
}

function getFolderIdFromSheet() {
  const sheet = SpreadsheetApp.openById("1qOkZrhiT-TkOKNcK5kmkK_rvH7uTOvfZVljtKJ0eN0U").getSheetByName("Files");
